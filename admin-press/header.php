...
foreach($ob->user_login_details() as $d){
$name = $d['u_name'];
$uimg = $d['u_img'];
    ...
    <div id="main-wrapper">
        ...
        <header class="topbar">
         ...
         <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img <?php echo('src="assets/images/users/'.$uimg.'"');?> alt="user" class="profile-pic" />
                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            ...
                                            <div class="u-text">
                                                <h4><?php echo($name); ?></h4>
                        <p class="text-muted"><?php echo($_SESSION['user']); ?></p><a href="pages-profile.html" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                        </div>
                                    </li>
...
echo('<div class="profile-img"> <img src="assets/images/users/'.$uimg.'" alt="user" />');
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Product</span></a>
                            <ul aria-expanded="false" class="collapse">
                            <li><a href="catlog.php">Catlog</a></li>
                            <li><a href="add-product.php">Add</a></li>
                            <li><a href="view-product.php">View</a></li>
                            </ul>
                        </li>
